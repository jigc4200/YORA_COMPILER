...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* start: NUMBER  */
#line 11 "yacc_example.y"
              { printf("Entrada válida: Un número\n"); }
#line 1056 "yacc_example.tab.c"
    break;


#line 1060 "yacc_example.tab.c"
